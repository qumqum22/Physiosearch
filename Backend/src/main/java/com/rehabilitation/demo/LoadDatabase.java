...
//            UserData userData8 = new UserData(null, "Kinga", "Lepszy","Female", null, "https://cdn.wallpapersafari.com/95/5/3rRDsg.jpg", "Witam w moim profilu",null);
            UserAccount userAccount1 = new UserAccount("piotr.pierwszy@example.com", "password", userData1);
            UserAccount userAccount2 = new UserAccount("agnieszka.druga@example.com", "password123", userData2);
            UserAccount userAccount3 = new UserAccount("michal@o2.pl", "passowordpl", userData3);
